...
export function localizedRsglBuildPreviewMessages(): RsglBuildPreviewMessages {
  return {
    ...
    summary: vscode.l10n.t("Summary: {0} create, {1} update, {2} unchanged",
      "{0}",
      "{1}",
      "{2}"
    ),
...
export function localizedWorkspaceBuildPreviewMessages(): RsglWorkspaceBuildPreviewMessages {
  return {
    ...
    summary: (sourceDirectories, created, updated, unchanged, skipped) => vscode.l10n.t("Summary: {0} source directories, {1} created, {2} updated, {3} unchanged, {4} skipped.",
      sourceDirectories,
      created,
      updated,
      unchanged,
